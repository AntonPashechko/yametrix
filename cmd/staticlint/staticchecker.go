...
import (
	...
	"github.com/AntonPashechko/yametrix/pkg/exitchecker"
)
...
func main() {
	...
	//Сторонний анализатор errwrap
	checks = append(checks, errwrap.Analyzer)

	//Сторонний анализатор errcheck
	checks = append(checks, errcheck.Analyzer)

	//Кастомный анализатор проверки отсутствия os.Exit в main/main
	checks = append(checks, exitchecker.OsExitCheckAnalyzer)
