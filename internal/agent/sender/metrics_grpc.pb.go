...
type MetricsServiceClient interface {
	...
	UpdateMetrics(ctx context.Context, in *UpdateMetricsReq, opts ...grpc.CallOption) (*emptypb.Empty, error)
}
...
func (c *metricsServiceClient) UpdateMetrics(ctx context.Context, in *UpdateMetricsReq, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	out := new(emptypb.Empty)
	err := c.cc.Invoke(ctx, "/metricsgrpc.MetricsService/UpdateMetrics", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type MetricsServiceServer interface {
	// Восстановление пароля пользователем
	UpdateMetrics(context.Context, *UpdateMetricsReq) (*emptypb.Empty, error)
...
func (UnimplementedMetricsServiceServer) UpdateMetrics(context.Context, *UpdateMetricsReq) (*emptypb.Empty, error) {
...
func _MetricsService_UpdateMetrics_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/metricsgrpc.MetricsService/UpdateMetrics",
	}
